...
export function ConvertInquiryForm({ inquiry, customers }: ConvertInquiryFormProps) {
  ...
  return (
    <div className="max-w-md space-y-6">
      <div>
        <h1 className="text-2xl font-bold tracking-tight">Convert Inquiry</h1>
        <p className="text-sm text-muted-foreground mt-1">
          Create a job from inquiry by {inquiry.contactName} ({inquiry.phone})
        </p>
      </div>
